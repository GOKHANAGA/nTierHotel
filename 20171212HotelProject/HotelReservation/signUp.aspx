...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container form-div-bg"><br />
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label text-info">User Name</label>
            <div class="col-sm-5">
        ...
        <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label text-info">Password</label>
            <div class="col-sm-5">
        ...
        <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label text-info">Password Again</label>
            <div class="col-sm-5">
                <%--<input type="password" class="form-control" id="inputPassword3" placeholder="Password"/>--%>
        ...
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label text-info">First Name</label>
            <div class="col-sm-5">
                <%-- <input type="email" class="form-control" id="inputEmail3" placeholder="Email" />--%>
        ...
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label text-info">Last Name</label>
            <div class="col-sm-5">
                <%-- <input type="email" class="form-control" id="inputEmail3" placeholder="Email" />--%>
        ...
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label text-info">Civilization Number</label>
            <div class="col-sm-5">
                <%-- <input type="email" class="form-control" id="inputEmail3" placeholder="Email" />--%>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <asp:Button ID="btnSignUp" class="btn form-btn" runat="server" Text="Sign Up" OnClick="btnSignUp_Click" />
            </div>
