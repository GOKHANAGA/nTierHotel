...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container form-div-bg">
        <div class="form-group">
            <label for="inputPassword3" class="col-sm-3 control-label blue-icon">Check_In</label>
            <label for="inputPassword3" class="col-sm-3 control-label blue-icon">Check_Out</label>
